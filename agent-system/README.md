...
| `NB2_MODEL` | No | Nano Banana 2 model ID (default: `gemini-3.1-flash-image`) |
| `NBPRO_MODEL` | No | Nano Banana Pro model ID (default: `gemini-3-pro-image`) |
...
## Model IDs (confirmed GA, June 2025)
